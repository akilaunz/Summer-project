...
def start(message):
    if message.text == '/start':
        bot.send_message(message.from_user.id,
                         "Здравствуйте! Введите, пожалуйста, страну сериала с большой буквы")
...
def get_country(message): 
    ...
    bot.send_message(message.from_user.id,
                     "Введите, пожалуйста, жанр сериала с маленькой буквы")
...
def get_genre(message):
    ...
    genre = message.text
    bot.send_message(message.from_user.id,
                     "Введите, пожалуйста, что именно вы хотите смотреть. Аниме? Дорама? Фильм? Шоу?")
...
def get_type(message):
    ...
    ttype = message.text
    bot.send_message(message.from_user.id,
                     "Введите, пожалуйста, производство какого канала вы бы хотели посмореть?")
